...
def build_drawing():
    ...
    _rect = draw.Rectangle(-1156.85, -541.26, 690.00, 700.00, fill='#f9c499', fill_opacity=1.00, stroke='#000000', stroke_width=2.00, data_label_id='rect_label_1', rx=9.37, ry=9.37)
    d.append(_rect)
    # Multiline label for rect_label_1
    _rect_label = draw.Text("SD Client State Machine (Services)", 12.00, -811.85, -520.26, fill='#000000', font_family='Arial', text_anchor='middle', dominant_baseline='alphabetic', line_height=1.333333, xml__space='preserve', data_shape_label='true', data_label_id='rect_label_1', data_label_h='center', data_label_v='top', data_font_px=12.0000, data_label_color_override='true', data_label_kind='rect', data_rect_label='true')
    ...
    _rect = draw.Rectangle(-1116.85, 18.74, 440.00, 110.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_4', rx=9.71, ry=9.71)
    d.append(_rect)
    ...
    _text = draw.Text(["Timer Expired", "/send(FindService)"], 9.00, -802.85, -27.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=140.0000, data_box_h=40.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)
    ...
    _text = draw.Text(["receive(OfferService)", "/resetTimer(TTL)"], 9.00, -722.85, -197.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=110.0000, data_box_h=40.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)
    ...
    _text = draw.Text(["[ServiceRequested and", "ifstatus==up_and_configured]"], 9.00, -1072.85, -147.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=140.0000, data_box_h=40.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _text = draw.Text(["receive(OfferService)", "/setTimer(TTL)"], 9.00, -852.85, -207.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=110.0000, data_box_h=30.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _text = draw.Text(["if-status-changed()", "[ifstatus==up_and_configured]"], 9.00, -892.85, -147.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=160.0000, data_box_h=30.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)
    ...
    _rect = draw.Rectangle(-1136.85, -501.26, 480.00, 190.00, fill='#f9c499', fill_opacity=1.00, stroke='#000000', stroke_width=2.00, data_label_id='rect_label_5', rx=12.64, ry=12.64)
    d.append(_rect)
    # Multiline label for rect_label_5
    _rect_label = draw.Text("Not Requested", 12.00, -896.85, -480.26, fill='#000000', font_family='Arial', text_anchor='middle', dominant_baseline='alphabetic', line_height=1.333333, xml__space='preserve', data_shape_label='true', data_label_id='rect_label_5', data_label_h='center', data_label_v='top', data_font_px=12.0000, data_label_color_override='true', data_label_kind='rect', data_rect_label='true')
    d.append(_rect_label)

    _text = draw.Text(["receive(ServiceOffer)", "/resetTimer(TTL)"], 9.00, -882.85, -337.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=160.0000, data_box_h=30.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)
    ...
    _text = draw.Text("receive(StopServiceOffer)", 9.00, -972.85, -367.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=170.0000, data_box_h=20.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _text = draw.Text(["receive(OfferService)", "/setTimer(TTL)"], 9.00, -962.85, -457.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=160.0000, data_box_h=30.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _rect = draw.Rectangle(-766.85, -261.26, 100.00, 40.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_6', rx=8.48, ry=8.48)
    d.append(_rect)
    # Multiline label for rect_label_6
    _rect_label = draw.Text("Service Ready", 12.00, -716.85, -236.26, fill='#000000', font_family='Arial', text_anchor='middle', dominant_baseline='alphabetic', line_height=1.333333, xml__space='preserve', data_shape_label='true', data_label_id='rect_label_6', data_label_h='center', data_label_v='middle', data_font_px=12.0000, data_label_color_override='true', data_label_kind='rect', data_rect_label='true')
    d.append(_rect_label)

    _rect = draw.Rectangle(-766.85, -441.26, 90.00, 100.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_7', rx=4.05, ry=4.05)
    d.append(_rect)
    ...
    _path = draw.Path('M -716.85 -221.26 L -716.85 -201.26 L -696.85 -201.26 L -696.85 -221.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -696.85 -221.26 L -691.85 -211.26 L -701.85 -211.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)
    ...
    _path = draw.Path('M -896.85 -221.26 L -896.85 -111.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -896.85 -111.26 L -901.85 -121.26 L -891.85 -121.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)
    ...
    _rect = draw.Rectangle(-966.85, -261.26, 170.00, 40.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_8', rx=12.77, ry=12.77)
    d.append(_rect)
    ...
    _rect = draw.Rectangle(-1126.85, -441.26, 90.00, 100.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_9', rx=4.05, ry=4.05)
    d.append(_rect)
    ...
    _rect = draw.Rectangle(-813.93, -64.80, 90.00, 30.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_10', rx=10.18, ry=10.18)
    d.append(_rect)
    ...
    _path = draw.Path('M -736.85 -221.26 L -736.85 -111.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -736.85 -111.26 L -741.85 -121.26 L -731.85 -121.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)

    _path = draw.Path('M -766.85 -351.26 L -1036.85 -351.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -1036.85 -351.26 L -1026.85 -356.26 L -1026.85 -346.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)

    _rect = draw.Rectangle(-796.85, 48.74, 100.00, 40.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_11', rx=13.57, ry=13.57)
    d.append(_rect)
    ...
    _path = draw.Path('M -756.85 -111.26 L -756.85 -161.26 L -756.85 -221.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -756.85 -221.26 L -751.85 -211.26 L -761.85 -211.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)
    ...
    _path = draw.Path('M -916.85 -111.26 L -916.85 -161.26 L -916.85 -221.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -916.85 -221.26 L -911.85 -211.26 L -921.85 -211.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)

    _text = draw.Text(["if-status-changed()", "[ifstatus!", "=up_and_configured]", "/cancelTimer(TTL)"], 9.00, -1002.85, -197.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=110.0000, data_box_h=50.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _rect = draw.Rectangle(-576.85, -261.26, 100.00, 40.00, fill='none', stroke='#000000', stroke_width=2.00, data_label_id='rect_label_12', rx=8.48, ry=8.48)
    d.append(_rect)
    # Multiline label for rect_label_12
    _rect_label = draw.Text("Stopped", 12.00, -526.85, -236.26, fill='#000000', font_family='Arial', text_anchor='middle', dominant_baseline='alphabetic', line_height=1.333333, xml__space='preserve', data_shape_label='true', data_label_id='rect_label_12', data_label_h='center', data_label_v='middle', data_font_px=12.0000, data_label_color_override='true', data_label_kind='rect', data_rect_label='true')
    d.append(_rect_label)

    _path = draw.Path('M -666.85 -251.26 L -576.85 -251.26', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -576.85 -251.26 L -586.85 -246.26 L -586.85 -256.26 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)

    _path = draw.Path('M -576.14 -238.43 L -666.14 -238.43', stroke='#000000', stroke_width=2.00, fill='none', data_arrow_start=False, data_arrow_end=True, data_arrow_head_length=10.00, data_arrow_head_width=10.00)
    # Arrowheads: start=false, end=true, length=10.00, width=10.00
    _arrow_head = draw.Path('M -666.14 -238.43 L -656.14 -243.43 L -656.14 -233.43 Z', fill='#000000', stroke='#000000', stroke_width=2.00)
    d.append(_arrow_head)
    d.append(_path)

    _text = draw.Text(["receive(StopOfferService)", "/cancelTimer(TTL)"], 9.00, -662.85, -277.26, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=140.0000, data_box_h=40.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)

    _text = draw.Text(["receive(OfferService)", "/resetTimer(TTL)"], 9.00, -664.27, -225.84, fill='#000000', font_family='Arial', text_anchor='start', dominant_baseline='text-before-edge', alignment_baseline='text-before-edge', line_height=1.111111, xml__space='preserve', data_doc_margin=4.0000, data_font_px=9.0000, data_scale=1.000000, data_box_w=110.0000, data_box_h=40.0000, data_text_h='left', data_text_v='top', data_text_dir='ltr')
    d.append(_text)
